export default function OpenaiCarousel() {
  const images = [
    { src: './openai-page/assets/4.jpg', alt: 'Image 1', description: 'Изображение превращает причудливого и детализированного искателя приключений в мага-паука в стиле, напоминающем размытую фотографию с камеры слежения низкого качества, сделанную в темной ночной обстановке при тусклом инфракрасном освещении.' },
